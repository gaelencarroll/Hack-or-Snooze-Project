...
class User {
  ...
  async toggleFavorites(fav,story){
    const newMethod = fav === 'add' ? 'POST' : 'DELETE'
  ...
  async newFavorite(story){
    this.favorites.push(story);
    await this.toggleFavorites('add',story)
  }

  async removeFavorite(story){
    this.favorites = this.favorites.filter(stories => stories.storyId !== story.storyId);
    await this.toggleFavorites('delete',story)
  }
